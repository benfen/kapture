...
{
	local first_option all_short_options='scdpreh'
	first_option="${1:0:1}"
...
print_help()
{
	...
	printf 'Usage: %s [-s|--stores <arg>] [-c|--customers <arg>] [-d|--simulation <arg>] [--redis-count <arg>] [--(no-)delete] [-p|--(no-)deploy-prometheus] [-r|--(no-)deploy-redis] [-e|--(no-)deploy-elastic-search] [-h|--help] <namespace> [<load-gen-count>]\n' "$0"
	...
	printf '\t%s\n' "-p, --deploy-prometheus, --no-deploy-prometheus: Deploy Prometheus as part of the cluster.  At this time, this option should be considered experimental and not fully functional. (off by default)"
