...
{
	local first_option all_short_options='scdph'
	first_option="${1:0:1}"
...
print_help()
{
	...
	printf 'Usage: %s [-s|--stores <arg>] [-c|--customers <arg>] [-d|--simulation <arg>] [--(no-)delete] [-p|--(no-)deploy-prometheus] [-h|--help] <namespace>\n' "$0"
